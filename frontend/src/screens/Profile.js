...
const Profile = () => {
    ...
    const {loading: loadingOrders, orders} = orderGetAll;
    ...
    const submitHandler = (e) => {
        ...
        if(password !== confirmPassword){
            ...
            dispatch(userProfileEdit({id: user._id, name: name, email: email, password: password}));
        }
    };
    ...
    return (
        ...
        <Row>
            ...
            <Col md={7}>
                ...
                : orders.length == 0 ? <Alert variant='info'>No Orders Found</Alert>
                : (
